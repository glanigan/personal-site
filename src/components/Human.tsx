    ...
    >
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/40 p-8">
        <blockquote className="text-lg leading-relaxed text-zinc-400">
          <span className="text-3xl leading-none text-orange-500/60">&ldquo;</span>
          <p className="mt-1">
            Walked the{" "}
            <span className="font-semibold text-orange-400">Inca Trail</span>.
            Survived deepest darkest Peru. Now mostly survives cycle planning.
          </p>
          <span className="text-3xl leading-none text-orange-500/60">&rdquo;</span>
        </blockquote>
