    ...
    >
      ...
      <div className="space-y-6 text-lg leading-relaxed text-zinc-400">
        <p>
          ...
          I lead engineering at Checkatrade with a tight grip on the end-user
          experience — not just the code. The best technical decisions are the
        ...
        <p>
          ...
          sounding board, a way to ship side projects faster than I could alone.
          I stay hands-on so I can lead my team with credibility.
        </p>
      </div>
    </section>
  );
